...
/**
Cette fonction retourne un tableau correspondant aux diff�rents attributs de Tweevent_email_validation.
*/
function getTab()
{
...
/**
Cette fonction modifie un �l�ment de la table tweevent_email_validation dans la BDD. 
*/
function UPD()
{
...
/**
Recup�re toutes les donn�es relatives � un tweevent_email_validation suivant son identifiant
et retourne la coquille "Tweevent_email_validation" remplie avec les informations r�cup�r�es
de la base.
