...
function Sql_buildSqlFile($out_file, $sql = '', $table = '') {
	...
	if (!$result) {
		echo 'Impossible d\'exécuter la requête : ' . mysqli_error($tab_session['db_link']);
		exit;
	}
/* TODO
	$list_fields = array();
...
* mysqli_connect() est fait avec les mêmes arguments mais va retourner l'identifiant
