...
if (!defined('__TWEEVENT_USER_INC__')) {
    ...
    class Tweevent_user extends Element
    {
        ...
        function getTab()
        {
            ...
            $tab['nom_tweevent_user'] = $this->nom_tweevent_user;
        ...
        function ADD()
        {
            ...
            $nom_tweevent_user = Sql_prepareTexteStockage($this->nom_tweevent_user);
            ...
            $siret = Sql_prepareTexteStockage($this->siret);
            ...
            $sql = " INSERT INTO " . $GLOBALS['prefix'] . "tweevent_user
					...
					mob_tweevent_user, derniere_ip_tweevent_user, siret, etat,
        ...
        function UPD()
        {
            ...
            $sql = " UPDATE " . $GLOBALS['prefix'] . "tweevent_user
				SET pseudo_tweevent_user = '$pseudo_tweevent_user', nom_tweevent_user = '$nom_tweevent_user', password_tweevent_user = '$password_tweevent_user', type_tweevent_user = '$type_tweevent_user',
					...
					mob_tweevent_user = '$mob_tweevent_user', siret = '$siret', etat = '$etat',
        ...
        function toStr()
        {
            ...
            $str = Lib_addElem($str, $this->nom_tweevent_user);
            ...
            $str = Lib_addElem($str, $this->siret);
    ...
    function Tweevent_user_recuperer($id_tweevent_user)
    {
        ...
        if ($result && Sql_errorCode($result) === "00000") {
            ...
            $tweevent_user->nom_tweevent_user = Sql_prepareTexteAffichage($row['nom_tweevent_user']);
            ...
            $tweevent_user->siret = Sql_prepareTexteAffichage($row['siret']);
        ...
        if (isset($args['count'])) {
            ...
            if ($result && Sql_errorCode($result) === "00000") {
                while ($row = Sql_fetch($result)) {
                    ...
                    $tab_result[$id]["nom_tweevent_user"] = Sql_prepareTexteAffichage($row['nom_tweevent_user']);
                    ...
                    $tab_result[$id]["siret"] = Sql_prepareTexteAffichage($row['siret']);
