...
/**
Cette fonction retourne un tableau correspondant aux diff�rents attributs de Tweevent_event.
*/
function getTab()
{
...
/**
Cette fonction modifie un �l�ment de la table tweevent_event dans la BDD. 
*/
function UPD()
{
...
/**
Recup�re toutes les donn�es relatives � un tweevent_event suivant son identifiant
et retourne la coquille "Tweevent_event" remplie avec les informations r�cup�r�es
de la base.
