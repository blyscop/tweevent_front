...
<div class="block_home center vcenter" style="height: 641px;">
    <div class="title_home inner">
        ...
        <div class="about">
            ...
            <h3><a href="#erreur_captchaNonSaisi" id="erreur_captchaNonSaisiBtn" role="button" data-toggle="modal"></a>
            </h3>
            <h3><a href="#erreur_captchaRequete" id="erreur_captchaRequeteBtn" role="button" data-toggle="modal"></a>
            </h3>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="register_form" name="frm_ajout_utilisateur"
                ...
                <div id="content_inscription" class="form-group modal-body">
                    Vous êtes : <br/>
                    <div class="col-xs-12">
                        <input type="radio" id="pro" name="choix_inscription" onclick="charger_bloc(this.id);"
                               value="pro"/><label for="pro">Un professionnel</label>
                    </div>
                    <div class="col-xs-12">

                        <input type="radio" id="par" name="choix_inscription" onclick="charger_bloc(this.id);"
                               value="par"/><label for="par">Un particulier</label> <br/>
                    </div>
                </div>
                <div class="g-recaptcha" data-sitekey="6LcDniETAAAAAFiX24Mw5sHqL2j0IqGJFGXqWkB0"
                     style="text-align: -moz-center;"></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class='form-group'>
                        <input required class="form-control" type="email" id="email_oublie" name="email_oublie"
                               value=""/> <br/>
                        <button type="submit" id="mdp_oublie_btn" onclick="mdp_oublie();"
                                class="btn btn-primary icon-user">Envoyer
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div id="reinit_ok" class="modal fade" tabindex="-12" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h5>Votre mot de passe a bien été réinitialisé ! Merci de cliquer sur le lien dans l-email reçu afin
                        de procéder au changement de mot de passe.</h5>
                </div>
            </div>
        </div>
    </div>
